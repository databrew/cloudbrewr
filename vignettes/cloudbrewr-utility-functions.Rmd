---
title: "cloudbrewr-utility-functions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{cloudbrewr-utility-functions}
...
To narrow down your catalog search:
```{r}
aws_s3_get_catalog(
  bucket = 'databrew.org',
...
aws_s3_get_table_ts(
  bucket = 'databrew.org', 
  key = 'kwale/anomalies/anomalies-identification-history/') %>% 
  head(5) %>% 
